...
class LoginCustomAutenticationAuthenticator extends AbstractLoginFormAuthenticator
{
    use TargetPathTrait;
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, string $firewallName): ?Response
    {
        ...
        if($this->auth->isGranted(User::ROLE_ADMIN)){
            ...
            return new RedirectResponse($this->urlGenerator->generate('app_supervisor_dashboard'));
        ...
        }elseif($this->auth->isGranted(User::ROLE_EXTERNO)){
            return new RedirectResponse($this->urlGenerator->generate('app_externo_dashboard'));
        }
