...
//        ;
//    }
public function getPublicacionUser($userId): ?array
    {
        ...
        user.nombres ,
        user.apellidos 
                    FROM App\Entity\Publicaciones publicacion
                    LEFT JOIN App\Entity\User user
                    WITH publicacion.userid = user.id
                    LEFT JOIN App\Entity\Categoria categoria
                    WITH publicacion.categoriaid = categoria.id
                    WHERE publicacion.userid = :user";
