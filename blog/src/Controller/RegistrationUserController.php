...
{
    /**
     * @Route("/", name="app_registration_user_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/new", name="app_registration_user_new", methods={"GET", "POST"})
     */
    public function new(Request $request, UserRepository $userRepository,UserPasswordHasherInterface $encoder): Response
    {
        ...
        $role = User::ROLE_TRABAJADOR; //inicializa con el rol de trabajador
        ...
        return $this->renderForm('registration_user/new.html.twig', [
            'user' => $user,
            'form' => $form,
        ]);
    }
    ...
    /**
     * @Route("/{id}", name="app_registration_user_show", methods={"GET"})
     */
    public function show(User $user): Response
    {
        return $this->render('registration_user/show.html.twig', [
            'user' => $user,
        ]);
    }
    ...
    public function edit(Request $request, User $user, UserRepository $userRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_registration_user_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->renderForm('registration_user/edit.html.twig', [
            'user' => $user,
            'form' => $form,
        ]);
    }
    ...
    /**
     * @Route("/{id}", name="app_registration_user_delete", methods={"POST"})
     */
